...
async searchCountryAndSelect(countryCode:string,countryName:string)
{
   ...
   // await this.country.fill(countryCode,{delay:100});
    ...
    {
        let text:any;  //note here this line is not written in typescript bit we wrote in typescript because whatif text variable
        //store blank values then for the blanl we dont know the datatype hence we wrote this line.
