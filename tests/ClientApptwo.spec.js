...
//below we will do end to end automation for some dummy ecommerce site
test('@Web End to End Automation Example', async ({page})=>
 {
 ...
 //note when we see for any tag has attribute classname and it has value with spaces that means there are multiple classnames
